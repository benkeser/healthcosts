...
We can now implement the Super Learner. Note that the run time on this Super Learner will be a bit longer than previous runs due to the additional layers of cross validation.  
